FROM alpine:3.19.0@sha256:51b67269f354137895d43f3b3d810bfacd3945438e94dc5ac55fdac340352f48 as nadeko-source

WORKDIR /nadeko

# renovate: datasource=gitlab-tags depName=Kwoth/nadekobot
ARG NADEKO_VERSION=4.3.18
...
FROM mcr.microsoft.com/dotnet/sdk:6.0@sha256:3354ef17b17ac0ec2c62753b4fd5d79b00c1cf80127b98252d869055b2b4566d AS build
WORKDIR /source
...
# final stage/image
FROM mcr.microsoft.com/dotnet/runtime:6.0@sha256:677831f531a537aad05b1a9ad43074697c0a9964b1eda696d955f3961aef913d
WORKDIR /app
